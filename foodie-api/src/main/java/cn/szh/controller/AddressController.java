...
public class AddressController {
    ...
    @ApiOperation(value = "根据用户id删除地址",notes = "根据用户id删除地址",httpMethod ="POST")
    @PostMapping("/delete")
    ...
    @ApiOperation(value = "设置地址为默认地址",notes = "设置地址为默认地址",httpMethod ="POST")
